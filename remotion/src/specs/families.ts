 ...
 *
 * Families 1-5 mirror the legacy hardcoded styles in AdvertiserAd.tsx
 * so the new pipeline can produce visually-equivalent output for the
 * categories that already work. Families 6-15 are new and unlock fresh
