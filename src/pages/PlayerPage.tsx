...
// La lógica de límite de apariciones por selfie (cap por cliente, conteo en
// localStorage, purga de expirados) vive en @/lib/selfie-shows y tiene sus
// propios tests. Es anti-abuso que cuesta dinero si se rompe.
...
export default function PlayerPage() {
  ...
  useEffect(() => {
    ...
    if (ad?.type === "video" && videoRef.current) {
      ...
      v.muted = true;
      v.play().catch((err) =>
        console.warn("video play() rejected (safety timer cubre):", err)
      );
